...
class FallDetectionHandler extends TaskHandler {
  final bool _isDetectionPaused = false;

  @override
  Future<void> onStart(DateTime timestamp, TaskStarter starter) async {
    debugPrint('[FallDetection] Service démarré à $timestamp');
  }
  ...
  Future<void> onDestroy(DateTime timestamp) async {
    debugPrint('[FallDetection] Service détruit à $timestamp');
  }
  ...
  void onReceiveData(Object data) {
    ...
    if (data == 'FALL_DETECTED') {
      debugPrint('[FallDetection] ⚠️ CHUTE DÉTECTÉE — envoi alerte...');
