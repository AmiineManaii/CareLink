...
class DetectionResultDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      ...
      title: Row(children: [
        const Icon(FontAwesomeIcons.magnifyingGlass, size: 42, color: Colors.teal),
      ...
      content: SingleChildScrollView(
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
                color: Colors.teal[50], borderRadius: BorderRadius.circular(16)),
          ...
          if (results.isNotEmpty) ...[
            ...
            const Row(children: [
              ...
              SizedBox(width: 4),
              Text('TFLite', style: TextStyle(fontSize: 14, color: Colors.teal)),
              SizedBox(width: 16),
              Icon(Icons.blur_on, size: 16, color: Colors.orange),
              SizedBox(width: 4),
              Text('ML Kit', style: TextStyle(fontSize: 14, color: Colors.orange)),
            ]),
          ],
        ]),
      ),
...
class DetectionPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final double scale = (widgetWidth / imageWidth) < (widgetHeight / imageHeight)
    ...
    for (final r in results) {
      ...
      (TextPainter(
        ...
        textDirection: TextDirection.ltr,
          ...
          .paint(canvas, Offset(ox + box.left * scale, oy + box.top * scale - 20));
    }
  }
